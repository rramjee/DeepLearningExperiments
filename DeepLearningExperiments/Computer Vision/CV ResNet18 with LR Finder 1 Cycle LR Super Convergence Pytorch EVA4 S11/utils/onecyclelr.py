...
class OneCycleLR:
    ...
    def step(self):
        ...
        if current_step <= self.num_cycle_steps // 2:
            ...
            #print("Out Optimizer: Do Nothing <--")
            return

        self.optimizer.param_groups[0]['lr'] = lr
        #print("In Optimizer.step: ", lr)
        #print("current_step: ", current_step)
        #print("self.num_cycle_steps: ", self.num_cycle_steps)
        #print("max_lr: ", self.max_lr)
        #print("min_lr: ", self.min_lr)
        #print("Out Optimizer: Values <--")
        if momentum:
